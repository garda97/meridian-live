...
export const config = {
  ...
  autoStrategy: {
    enabled: u.autoStrategyEnabled ?? true,
    fetchIndicators: u.autoStrategyFetchIndicators ?? true,
    indicatorInterval: nonEmptyString(u.autoStrategyIndicatorInterval, "15_MINUTE"),
    allowSpot: u.autoStrategyAllowSpot ?? true,
    allowCurve: u.autoStrategyAllowCurve ?? true,
